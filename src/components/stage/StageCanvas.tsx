...
export const StageCanvas: React.FC = () => {
  ...
  if (!isGuestJoined) {
    return (
      <div className="min-h-screen bg-[#FAF9F6] p-4 sm:p-8 lg:p-12 xl:p-16 flex items-center justify-center font-['Plus_Jakarta_Sans',sans-serif]">
        <div className="w-full max-w-[1360px] mx-auto animate-fade-in">
